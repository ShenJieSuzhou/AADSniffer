...
#pragma mark - - - 扫描外部View的创建
    ...
    promptLabel.text = NSLocalizedString(@"QRCodeDes", nil);
...
#pragma mark - - - 扫描边角imageView的创建
    ...
    UIImage *left_image = [UIImage imageNamed:@"SnailQRCodeRes.bundle/QRCodeLeftTop"];
    ...
    // 右上侧的image
    UIImage *right_image = [UIImage imageNamed:@"SnailQRCodeRes.bundle/QRCodeRightTop"];
    ...
    // 左下侧的image
    UIImage *left_image_down = [UIImage imageNamed:@"SnailQRCodeRes.bundle/QRCodeLeftBottom"];
    ...
    // 右下侧的image
    UIImage *right_image_down = [UIImage imageNamed:@"SnailQRCodeRes.bundle/QRCodeRightBottom"];
...
- (UIImageView *)scanningline {
    if (!_scanningline) {
        ...
        _scanningline.image = [UIImage imageNamed:@"SnailQRCodeRes.bundle/QRCodeScanningLine"];
